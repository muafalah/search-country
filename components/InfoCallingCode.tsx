...
interface InfoCallingCodeProps {
  callingCode: string | null | undefined;
  countries: any[];
}

const InfoCallingCode = ({ callingCode, countries }: InfoCallingCodeProps) => {
  return (
    <Card className="w-full md:w-1/2 border-0 m-0 p-0 shadow-none">
      <CardHeader className="px-0">
        <CardTitle>Calling Code</CardTitle>
      </CardHeader>
...
export default InfoCallingCode;
